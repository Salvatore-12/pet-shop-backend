...
public class ProdottoRunner implements CommandLineRunner {
    ...
    public void createProdotti(){
        ...
        //CROCCHETTE CANE
     Prodotto crocchetteCane1= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRv_ZGVk_hhYAhP2JCzaFRMYfHb3UDGG-hLMQ&usqp=CAU","Gemon All Breeds Crocchette Cane Adult con Agnello e Riso 15kg","crocchette per il cane",32.00,Categoria.Crocchette,TipoAnimale.Cane);
     ...
     Prodotto crocchetteCane5= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMmb4sDbAvR_Dyg7B5SQm6LIXG6LBOIkfYGQ&usqp=CAU","CROCCHETTE SEMI UMIDE PER CANE CON MANZO, CAROTE E CEREALI 1,5 KG - FROLIC","crocchette per il cane",11.50,Categoria.Crocchette,TipoAnimale.Cane);
        ...
        Prodotto ciboUmidoCane3= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTnW5tyt1HcWP_IR5qc1og0iO90N6qaYHMmRzMHL0ANX1RN4uNMQg6LvfL-i4XHjTR76WI&usqp=CAU","Monge Grill Maiale Cibo Umido Per Cani Adulti 100G","cibo umido monge grill maiale per cani",0.66,Categoria.Cibo_umido,TipoAnimale.Cane);
        Prodotto ciboUmidoCane4= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSV1DyJz4Zj3FzxvqBDm09Br9uQ32hyPiNq4g&usqp=CAU","Pura Natura pollo mele ed erbe officinali cibo umido per cani","cibo umido  pollo mele ed erbe officinali per cani ",1.80,Categoria.Cibo_umido,TipoAnimale.Cane);
        Prodotto ciboUmidoCane5= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQz2karhaJquK51H-htIiMXJzg5IRGQNTEFkacLmzk1v6dH-VAiXchs_0emYcgmGzpiuYE&usqp=CAU","Cibo Umido per Cani Natural Trainer Manzo 400 gr","cibo umido manzo per cani",3.50,Categoria.Cibo_umido,TipoAnimale.Cane);
        ...
        prodottoDAO.save(ciboUmidoCane5);
        ...
        //CUCCIE CANE
        Prodotto CuccieCane1 = new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTit49BTWZT_-8bKM4Xw1OzRm19WFvCCn3eFA&usqp=CAU","Cadoca Cuccia da Esterno per Cani XXL Legno Massello Tetto Apribile 82cmx72cmx85cm","cuccia in legno per cani ",136.00,Categoria.CuccieELettini,TipoAnimale.Cane);
     ...
     Prodotto GiocoPerIlGatto5= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRaJrNsiGVU6oKXqGBIjtDfAL0r68y8vAVtIQ&usqp=CAU","Campo giochi per gatto con graffiatoio e palline sonore - Triangulo","campo giochi ideale per il nostro amico peloso",19.99,Categoria.Giochi,TipoAnimale.Gatto);
      ...
      Prodotto CiotolaGatto1= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqWmcwiWkwp-F6OiRuAOfrvkNmukVAkB2tOW3x9ymA7wj7B2cZR1Vw2CessJzW3Yz5D_o&usqp=CAU","CIOTOLA PER GATTI IN CERAMICA CON SUPPORTO IN LEGNO","ciotola in ceramica per gatto",10.00,Categoria.CiotoleEDistributori,TipoAnimale.Gatto);
      Prodotto CiotolaGatto2= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyEJ_kZ9lnfVzC7OQczjcoZ24JUiS3fkTQ7Q&usqp=CAU","CIOTOLA Doppia PER GATTI ","bellissima ciotola doppia per gatto",44.00,Categoria.CiotoleEDistributori,TipoAnimale.Gatto);
      ...
      Prodotto CiotolaGatto4= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvAvfC1rTr0C2ddjvXtRJS7cHJMYdrjlQaeQ&usqp=CAU","Ciotola per Gatto Yummy Rosa","bellissima ciotola per gatto rosa",8.00,Categoria.CiotoleEDistributori,TipoAnimale.Gatto);
     ...
     Prodotto CrocchetteGatto1= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgcGQMC6rjlVpCA2WREnxEfyJVIbLqi2a8HA&usqp=CAU","Crocchette Senza Cereali per Gatti Adulti Sensibili","crocchette per gatti",17.99,Categoria.Crocchette,TipoAnimale.Gatto);
     Prodotto CrocchetteGatto2= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHiebpuYkXSRbmitna7ZQsMvzjdGe_6AEorw&usqp=CAU","Crocchette Per Gatti Royal Canin Feline Mother And Babycat Gattini 400 Grammi","crocchette per gatti",7.90,Categoria.Crocchette,TipoAnimale.Gatto);
     Prodotto CrocchetteGatto3= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-FLFXeGVikd9Jc9g4h-cU5VbpfWKDWgXbGUXJgbMZg5jg0B4NHVvhxLyIs17hqS_cyIw&usqp=CAU","Crocchette per gatti con tonno 2 kg","crocchette per gatti",4.00,Categoria.Crocchette,TipoAnimale.Gatto);
     ...
     Prodotto CrocchetteGatto5= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT7qV45WmJ_uCm28Nila_VOcbOs_lrhbBQQuw&usqp=CAU","Friskies Adult Crocchette Per Il Gatto, Con Coniglio, Pollo E Verdure Aggiunte, 2 Kg","crocchette per gatti ",9.90,Categoria.Crocchette,TipoAnimale.Gatto);
        ...
        Prodotto CiboUmidoGatto2= new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMtK2pSOeTQ4tYIwlBVjWV97Wc-1WbkVgS7A&usqp=CAU","Cibo Umido al Pesce e Pollo per Gatti","cibo umido per gatto",2.30,Categoria.Cibo_umido,TipoAnimale.Gatto);
        ...
        Prodotto accessoriGabbie1 = new Prodotto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShzaPOFnFLRduGOM-srA3Rq9j-xIP-jEP5DCRWy_4V9ln4xFdUKe3ZNGJ1bb3j0srR9Cs&usqp=CAU","Ricambio mangiatoia Gabbie Piccoli Uccelli 8 x 6 x 4 cm","mangiatoia gabbie per piccoli uccelli",9.99,Categoria.AccessoriPerGabbie,TipoAnimale.Uccello);
