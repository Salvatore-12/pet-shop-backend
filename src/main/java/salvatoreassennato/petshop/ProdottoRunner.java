...
public class ProdottoRunner implements CommandLineRunner {
    ...
    public void createProdotti(){
        ...
        Prodotto prodottoPerIlCane3=new Prodotto("https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcT4HsrN3lY0QY7KCBpxVHJoDsJpBmdxZJtoJXckHoU8-ETviwjQnRUofwl_FbTLTn28NlGpyvljzfLR-KcZluY9yYdjv85PljMB-h0Yrqi68NqgQwZuWNg0ulITGp0ObmqU0rN3_w&usqp=CAc","guinzaglio rosso in nylon","comodo guinzaglio per il nostro amico a quattro zampe",5.99,"price_1OoM8HC3pyi397slql542GYi",Categoria.Guinzaglio,TipoAnimale.Cane);
